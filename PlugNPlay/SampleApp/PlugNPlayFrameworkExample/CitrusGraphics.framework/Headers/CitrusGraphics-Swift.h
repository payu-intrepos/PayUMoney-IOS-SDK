...
SWIFT_MODULE_NAMESPACE_PUSH("CitrusGraphics")

SWIFT_CLASS("_TtC14CitrusGraphics14CitrusGraphics")
@interface CitrusGraphics : NSObject
/// Clear memory cache & disk cache right away. This is an async operation.
///
/// returns:
